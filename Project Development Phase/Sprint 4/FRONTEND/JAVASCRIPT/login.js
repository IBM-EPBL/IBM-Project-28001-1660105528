...
signupForm.elements[2].addEventListener("change", (e) => {
 ...
 "Your password should be of 8 character with atleast one uppercase, one 
lowercase, one number and one special digit"
 );
 e.target.value = "";
 } else {
 e.target.setCustomValidity("");
...
signinForm.addEventListener("submit", async (e) => {
 ...
 signinForm.querySelector("h2").innerText="⚠️ Please verify your mail by 
